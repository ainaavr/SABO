...
public class AinaAvrilia_Delete {
	...
	int countRecordDeleted = 0;
		String deleteTableQuery = "DELETE FROM daftarmhs WHERE id = '11124' ";
	try {
		...
		System.out.println(countRecordDeleted + " record telah berhasil dihapus pada tabel daftarmhs!");
	}
